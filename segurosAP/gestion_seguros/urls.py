...
urlpatterns = [
    ...
    path('gestion_asegurados/cartera_asegurados/<int:asegurado_id>', views.cartera_asegurados, name='cartera_asegurados'),
    ...
    path('gestion_asegurados/detalle_asegurado/<int:asegurado_id>', views.detalle_asegurado, name='detalle_asegurado'),
